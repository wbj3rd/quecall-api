...
let ExtensionRepository = class ExtensionRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Extension, dataSource);
    }
};
ExtensionRepository = tslib_1.__decorate([
